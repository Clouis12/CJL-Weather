window.addEventListener('load', function () {
  ...
  function getForecast(searchValue) {
    ...
    var endpoint = `https://api.openweathermap.org/data/2.5/forecast?q=${searchValue}&appid=15038671c45c9502c274d6b86b0d82bb&units=imperial`;
    fetch(endpoint)
      .then((res) => res.json())
      .then((data) => {
  ...
  function getUVIndex(lat, lon) {
    fetch(
      `http://api.openweathermap.org/data/2.5/uvi?appid=15038671c45c9502c274d6b86b0d82bb&lat=${lat}&lon=${lon}`
    )
      .then((res) => res.json())
      .then((data) => {
  ...
  function searchWeather(searchValue) {
    var endpoint = `http://api.openweathermap.org/data/2.5/weather?q=${searchValue}&appid=15038671c45c9502c274d6b86b0d82bb&units=imperial`;
    fetch(endpoint)
      .then((res) => res.json())
      .then((data) => {
